export const useOrchidListStore = defineStore('orchidList',()=>{
    ...
    async function getOrchidList (){
        let url = 'https://server.orchids.com.cn/api/orchids?pagination[page]=1&pagination[pageSize]=10'
    ...
    async function  changeOrchidList(classID) {
        let url = 'https://server.orchids.com.cn/api/orchids?pagination[page]=1&pagination[pageSize]=10&filters[orchidclass][documentId][$eq]='+classID
